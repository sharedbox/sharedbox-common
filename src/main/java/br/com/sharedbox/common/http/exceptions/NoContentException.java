package br.com.sharedbox.common.http.exceptions;
...
import br.com.sharedbox.common.security.Token;
...
public class NoContentException extends Exception {
     ...
     */
    public NoContentException(String message, String code, String idTransaction) {
     ...
     * @since  1.4
     */
    public NoContentException(String message, String code, Throwable cause) {
     ...
     * @since  1.4
     */
    public NoContentException(String message, String code, String idTransaction, Throwable cause) {
        super(message + ". CODE: " + code + ". Id transaction: " + idTransaction);
     ...
     * @since 1.7
     */
    protected NoContentException(String message, Throwable cause,
     ...
     * @param cause
     */
    public NoContentException(Map<String, Message> messages, String idTransaction) {
     ...
     * @param cause
     */
    public NoContentException(Map<String, Message> messages) {
     ...
     * @param cause
     */
    public NoContentException(Map<String, Message> messages, Throwable cause) {
